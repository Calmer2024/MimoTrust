...
│                        用户场景                              │
│  ┌──────────────┐    ┌──────────────┐    ┌──────────────┐   │
│  │ 受控内容沙盒  │    │  小真 App     │    │  Web Demo    │   │
│  │ (Flutter)    │───→│  (Kotlin)    │    │  (静态页面)   │   │
│  │ 视频浏览/互动 │    │  分享/悬浮球  │    │  浏览器测试   │   │
│  └──────────────┘    └──────┬───────┘    └──────┬───────┘   │
│         │                   │                    │           │
│         └── 广播/分享 ──────┘                    │           │
└─────────────────────────────────────────────────┼───────────┘
...
| [后端说明](docs/后端说明.md) | M1-M7 流水线架构、内容提取、Job 系统、安全设计 |
| [接口文档](docs/接口文档.md) | Web / Job / 受控内容全部 API 接口 |
| [小真 App 说明](docs/小真App说明.md) | Android 模块、接口示例、生产部署 |
| [沙盒说明](docs/沙盒说明.md) | Context 2.2 协议、网关接口、真机验收记录 |
| [模块化核验流水线升级说明](docs/模块化核验流水线升级说明.md) | M1-M7 数据协议详细规范 |
